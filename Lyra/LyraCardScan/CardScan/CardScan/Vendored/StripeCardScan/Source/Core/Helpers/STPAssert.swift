...
func stpAssertionFailure(_ message: @autoclosure () -> String = String(), file: StaticString = #file, line: UInt = #line) {
#if ENABLE_STPASSERTIONFAILURE
...
/// Use this for assertions that should not trigger in merchant apps.
func stpAssert(_ condition: @autoclosure () -> Bool, _ message: @autoclosure () -> String = String(), file: StaticString = #file, line: UInt = #line) {
#if ENABLE_STPASSERTIONFAILURE
